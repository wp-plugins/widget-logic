...
{	global $wp_registered_widgets, $wp_registered_widget_controls;
	...
	{	$wl_options['widget_logic-options-filter']=$_POST['widget_logic-options-filter'];
		$wl_options['widget_logic-options-rewind']=$_POST['widget_logic-options-rewind'];
	}
	update_option('widget_logic', $wl_options);
}
	...
	?><div class="wrap">
		<form method="POST">
			...
			<input id="widget_logic-options-filter" name="widget_logic-options-filter" type="checkbox" value="checked" class="checkbox" <?php echo $wl_options['widget_logic-options-filter'] ?> /></label>
				&nbsp;&nbsp;
			<label for="widget_logic-options-rewind">Use 'rewind_posts' fix
			<input id="widget_logic-options-rewind" name="widget_logic-options-rewind" type="checkbox" value="checked" class="checkbox" <?php echo $wl_options['widget_logic-options-rewind'] ?> /></label>
