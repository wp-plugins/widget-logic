...
[Widget Logic By Path](http://wordpress.org/plugins/widget-logic-by-path/) is a nice extension to Widget Logic that makes good use of this filter. It provides basic wild-card or full reg-ex matching on URL path plus some basic tags that replicate is_home() and is_front_page() but with the peace of mind that "no exec" brings.

= Donations =

If you like and use Widget Logic you could consider a small donation to Cancer Research UK. I have a [JustGiving.com donation link](http://www.justgiving.com/widgetlogic_cancerresearchuk). As of July 2014 we have raised 840 GBP. I'd like to hit 1000 UKP by the end of the year.
